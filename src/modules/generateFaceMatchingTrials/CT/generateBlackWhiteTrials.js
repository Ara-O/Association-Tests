...
function generatePracticeTrials(trials, practice = false) {
  ...
  for (let i = 0; i < trials / 2; i++) {
    ...
    if (i % 2 === 0) {
      ...
      //   console.log(
      //     "Male black: ",
      //     chosenMaleBlackImages[blackMaleCounter],
      //     "i - ",
      //     blackMaleCounter
      //   );
      ...
      if (randomNo % 2 === 0) {
        ...
        dataToPush.leftImage =
          chosenMaleBlackImages[rollRandomIndex(chosenMaleBlackImages, i)];
      ...
      if (randomNo % 2 === 0) {
        ...
        dataToPush.rightImage =
          chosenMaleWhiteImages[rollRandomIndex(chosenMaleWhiteImages, i)];
      } else {
        dataToPush.correctImagePosition = "left";
        dataToPush.rightImage =
          chosenMaleBlackImages[
  ...
  for (let i = 0; i < trials / 2; i++) {
    if (i % 2 === 0) {
      ...
      //   console.log(
      //     "Female black: ",
      //     chosenFemaleBlackImages[blackFemaleCounter]
      //   );
      ...
      if (randomNo % 2 === 0) {
        dataToPush.correctImagePosition = "left";
        dataToPush.leftImage =
          chosenFemaleBlackImages[rollRandomIndex(chosenFemaleBlackImages, i)];
        dataToPush.rightImage =
      ...
      //   console.log(
      //     "female white: ",
      //     chosenFemaleWhiteImages[whiteFemaleCounter]
      //   );
      ...
      if (randomNo % 2 === 0) {
        ...
        dataToPush.rightImage =
          chosenFemaleWhiteImages[rollRandomIndex(chosenFemaleWhiteImages, i)];
      } else {
        dataToPush.correctImagePosition = "left";
        dataToPush.rightImage =
          chosenFemaleBlackImages[
