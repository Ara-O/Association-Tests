  ...
  <main>
    <section id="test-border">
      <div v-if="notStarted" class="instruction">
        ...
        ></h3>
        <h3>
          When you are ready, please click the SPACE bar on your keyboard to
          start
        </h3>
        <!-- SPACE BAR -->
        <img
    ...
    return {
      ...
      fullTest: [
        ...
        },
        {
          block: "Block2",
          instructions:
            "Click E for office items, and I for kitchen items. Remember, you should tap as fast as you can!",
          data: trials.testData_Block2("E", "I", 16),
        },
        {
          block: "Block3",
          instructions:
            "Practice: Click E for Male images/Office items, and I for Female images/Kitchen items",
          data: trials.testData_Block3("E", "I", 8, true),
        },
        {
          block: "Block4",
          instructions:
            "Click E for male images and office items, and I for female images and kitchen items. Remember, you should tap as fast as you can!",
        ...
        },
        {
          block: "Block6",
          instructions:
            "Practice: Click I for Male images and Kitchen items, and E for Female images and Office items",
          data: trials.testData_Block4("I", "E", 8, true),
        },
        {
          block: "Block7",
          instructions:
            "Click I for male images and kitchen items, and E for female images and office items. Remember, you should tap as fast as you can!",
