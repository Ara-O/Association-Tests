...
export default {
  ...
  data() {
    return {
      ...
      irbt_trials: [
        ...
        touch the female face at the bottom of the screen; when you see an Office item, you should touch
      ...
      quickly and correctly. You can only use one hand to touch
        ...
        {
          trials: genderAndRoles("male.jpg", "female.jpg", 24),
          section: "section_1",
      ...
      quickly and correctly. You can only use one hand to touch
        ...
        {
          trials: genderAndRoles("female.jpg", "male.jpg", 8),
          section: "practice_2",
          instruction: `Practice: There will be a picture of a Kitchen item or an Office item in the
        middle of the screen. When you see a picture of an Office item, you should
        touch the female face at the bottom of the screen; when you see a Kitchen item, you should touch
        the Male face. Male faces and Female faces will appear at the bottom of
        the screen either on the left or right. Pay attention because the
        male and female faces may change places. Please respond
      quickly and correctly. You can only use one hand to touch
        ...
        {
          trials: genderAndRoles("female.jpg", "male.jpg", 24),
          section: "section_2",
          instruction: `There will be a picture of a Kitchen item or an Office item in the
        middle of the screen. When you see a picture of an Office item, you should
        touch the female face at the bottom of the screen; when you see a Kitchen item, you should touch
  ...
  methods: {
    ...
    leftFaceAction() {
      irbt.leftFaceAction(this, "gender", "IBT_Gender_Roles");
    },
    rightFaceAction() {
      irbt.rightFaceAction(this, "gender", "IBT_Gender_Roles");
    },

    handleCorrectAnswer() {
      irbt.handleCorrectAnswer(this, "IBT_Gender_Roles", "IBT_Gender_Roles");
    },
  ...
  mounted() {
    this.$store.state["IBT_Gender_Roles"] = [];
    this.$store.commit("changeCurrentTest", "IBT_Gender_Roles");
  },
};
</script>
