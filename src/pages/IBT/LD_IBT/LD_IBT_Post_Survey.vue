<template>
    <section class="flex items-center justify-center h-screen" v-show="currentStep === 1">
        <div class="result-box" style="max-width: 500px">
            ...
            <h3 class="text-sm leading-7 ">Biases are mental shortcuts formed from our experiences. Implicit bias
                or
                unconscious
                bias
                impacts our judgement
                without our awareness. Recognizing these biases is crucial because they can perpetuate societal
                inequalities,
                lead
                to emotional distress, and hinder the growth of inclusive, supportive communities.
    ...
    <section class="flex items-center justify-center h-screen " v-show="currentStep === 2">
        <div class="result-box-questions ">
            ...
            <h3 class="text-[13px] leading-7">
                Scenario: Please read the scenario described below and answer the questions that follow. There are no right
                or wrong answers. Please answer based on the first thought that comes to your mind.
            </h3>

            <h3 class="text-[13px] leading-7 border border-solid box-border border-gray-500 p-4">
                Sam is a 9-year-old boy who is currently in Grade 4 in a Public School in suburban Ontario. Up until Grade
                3, Sam was scoring slightly below average to average in almost all his classes but
                now his grades are slipping. He works slowly on assignments but is a hard worker. His teacher asks him to
                complete shorter assignments than his classmates and he gets more time on tests than his classmates. In
                general, he is unable to complete assignments on his own. When the teacher has time to sit down with him and
                talk him through the work, Sam is able to work through the task. His reading is slow and labored. Sam’s
                parents are very concerned about their son, especially because he is trying hard to achieve but is often
                frustrated with himself. They often meet Sam’s teacher/s to get feedback about his performance in the class.
            </h3>
                    ...
                    <div class="flex items-center justify-between w-full ">
                        <span>
                            <input type="radio" value="1" id="1"
                                v-model="surveyData['On a scale of 1 (immediately) to 5 (waiting to see how Sam performs in the future), how soon do you think Sam’s academic difficulties should be addressed at school?']" />
                            <label for="1">1</label>
                        </span>
                        <span>
            ...
            <!-- Question 2 -->
            <h3 class="font-medium"> 2. The following statements are about different things that could be contributing to
                Sam’s academic or learning
                difficulties; Please rate each of these possible options with 1 being-contributing the most to 4-
                contributing the least.
                Please tick the option that best match(s) your opinion, and indicate the extent to which you feel each
                factor is contributing to Sam’s difficulties in learning
            </h3>
            ...
            <div>
                <span>
                    ...
                    <input type="text" placeholder="Extent (1 - 5)" class="w-20 text-xs text-center py-0.5"
                        v-model="surveyData['The following statements are about different things that could be contributing to Sam’s academic or learning difficulties; Please rate each of these possible options with 1 being-contributing the most to 4-contributing the least; Please tick the option that best match(s) your opinion, and indicate the extent to which you feel each factor is contributing to Sam’s difficulties in learning']['Sam']">
                </span>
                <br>
                <span>
                    <input type="checkbox" name="" id="people-around">
                    <label for="people-around" class="mr-3">The people around him (teachers, parents etc)</label>
                    <input type="text" placeholder="Extent (1 - 5)" class="w-20 text-xs text-center py-0.5"
                        v-model="surveyData['The following statements are about different things that could be contributing to Sam’s academic or learning difficulties; Please rate each of these possible options with 1 being-contributing the most to 4-contributing the least; Please tick the option that best match(s) your opinion, and indicate the extent to which you feel each factor is contributing to Sam’s difficulties in learning']['The people around him (teachers, parents etc)']">
                </span>
                <br>
                <span>
                    <input type="checkbox" name="" id="systemic-factors">
                    <label for="systemic-factors" class="mr-3">Systemic factors (education system, health system)</label>
                    <input type="text" placeholder="Extent (1 - 5)" class="w-20 text-xs text-center py-0.5"
                        id="systemic-factors"
                        v-model="surveyData['The following statements are about different things that could be contributing to Sam’s academic or learning difficulties; Please rate each of these possible options with 1 being-contributing the most to 4-contributing the least; Please tick the option that best match(s) your opinion, and indicate the extent to which you feel each factor is contributing to Sam’s difficulties in learning']['Systemic factors (education system, health system)']">
                </span>
                <br>
                <span>
                    <input type="checkbox" name="" id="financial-or-academic">
                    <label for="financial-or-academic" class="mr-3">His financial or academic situation</label>
                    <input type="text" placeholder="Extent (1 - 5)" class="w-20 text-xs text-center py-0.5"
                        id="financial-or-academic"
                        v-model="surveyData['The following statements are about different things that could be contributing to Sam’s academic or learning difficulties; Please rate each of these possible options with 1 being-contributing the most to 4-contributing the least; Please tick the option that best match(s) your opinion, and indicate the extent to which you feel each factor is contributing to Sam’s difficulties in learning']['His financial or academic situation']">
                </span>
                <br>
                <h4 class="text-sm">(As an example: lack of school resources that can support Sam’s learning)
                </h4>
            </div>

            <!-- Question 3 -->
            <h3 class="font-medium mt-10">3. Who or what is more responsible for changing or bringing about an improvement
                in Sam’s situation (Tick all that apply)</h3>

            <label for="sam-himself" class="mr-3">Sam himself</label>
            <input type="checkbox" name="q3" value="Sam himself" id="sam-himself"
                v-model="surveyData['Who or what is more responsible for changing or bringing about an improvement in Sam’s situation (Tick all that apply)']">
            <br>
            <label for="his-teachers" class="mr-3">His teachers</label>
            <input type="checkbox" name="q3" value="His teachers" id="his-teachers"
                v-model="surveyData['Who or what is more responsible for changing or bringing about an improvement in Sam’s situation (Tick all that apply)']">
            <br>
            <label for="parents" class="mr-3">Parents</label>
            <input type="checkbox" name="q3" value="Parents" id="parents"
                v-model="surveyData['Who or what is more responsible for changing or bringing about an improvement in Sam’s situation (Tick all that apply)']">
            <br>
            <label for="situational-changes" class="mr-3">Situational changes</label>
            <input type="checkbox" name="" value="Situational changes" id="situational-changes"
                v-model="surveyData['Who or what is more responsible for changing or bringing about an improvement in Sam’s situation (Tick all that apply)']">
            <br>
            <h3>e.g., providing more school resources and funding to provide better support for students like Sam)
            </h3>
    ...
    <section class="flex items-center justify-center h-screen flex-col" v-show="currentStep === 3">
        <div class="result-box-questions" style="width: 1000px !important">
            <h3 class="font-medium mt-7"> To what extent do you agree with the following statements? (1= Strongly
                disagree,
                5 = Strongly agree)
            </h3>
            ...
            <table>
                ...
                <tr>
                    <td>1. Sam is struggling because he does not put enough effort into his schoolwork.</td>
                    <td>
                        <input type="radio" name="sam-struggling-question" value="1"
                            v-model="surveyData['Sam is struggling because he does not put enough effort into his schoolwork']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-struggling-question" value="2"
                            v-model="surveyData['Sam is struggling because he does not put enough effort into his schoolwork']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-struggling-question" value="3"
                            v-model="surveyData['Sam is struggling because he does not put enough effort into his schoolwork']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-struggling-question" value="4"
                            v-model="surveyData['Sam is struggling because he does not put enough effort into his schoolwork']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-struggling-question" value="5"
                            v-model="surveyData['Sam is struggling because he does not put enough effort into his schoolwork']" />
                    </td>
                </tr>
                <tr>
                    <td>
                        2. Sam’s difficulties are due to differences in his brain function (which impact how he learns).
                    </td>
                    <td>
                        <input type="radio" name="sam-brain-function-question" value="1"
                            v-model="surveyData['Sam’s difficulties are due to differences in his brain function (which impact how he learns)']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-brain-function-question" value="2"
                            v-model="surveyData['Sam’s difficulties are due to differences in his brain function (which impact how he learns)']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-brain-function-question" value="3"
                            v-model="surveyData['Sam’s difficulties are due to differences in his brain function (which impact how he learns)']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-brain-function-question" value="4"
                            v-model="surveyData['Sam’s difficulties are due to differences in his brain function (which impact how he learns)']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-brain-function-question" value="5"
                            v-model="surveyData['Sam’s difficulties are due to differences in his brain function (which impact how he learns)']" />
                    </td>
                </tr>
                <tr class="text-xs">
                    <td>3. Sam is struggling because his family lacks the necessary financial and material
                        resources to succeed </td>
                    <td>
                        <input type="radio" name="sam-financial-struggle-question" value="1"
                            v-model="surveyData['Sam is struggling because his family lacks the necessary financial and material resources to succeed']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-financial-struggle-question" value="2"
                            v-model="surveyData['Sam is struggling because his family lacks the necessary financial and material resources to succeed']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-financial-struggle-question" value="3"
                            v-model="surveyData['Sam is struggling because his family lacks the necessary financial and material resources to succeed']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-financial-struggle-question" value="4"
                            v-model="surveyData['Sam is struggling because his family lacks the necessary financial and material resources to succeed']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-financial-struggle-question" value="5"
                            v-model="surveyData['Sam is struggling because his family lacks the necessary financial and material resources to succeed']" />
                    </td>
                </tr>
                <tr>
                    <td>
                        4. Sam is struggling at school because of the bad deeds he engaged in during his past
                        life which impact him negatively now (bad karma).
                    </td>
                    <td>
                        <input type="radio" name="sam-bad-deeds-question" value="1"
                            v-model="surveyData['Sam is struggling at school because of the bad deeds he engaged in during his past life which impact him negatively now (bad karma)']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-bad-deeds-question" value="2"
                            v-model="surveyData['Sam is struggling at school because of the bad deeds he engaged in during his past life which impact him negatively now (bad karma)']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-bad-deeds-question" value="3"
                            v-model="surveyData['Sam is struggling at school because of the bad deeds he engaged in during his past life which impact him negatively now (bad karma)']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-bad-deeds-question" value="4"
                            v-model="surveyData['Sam is struggling at school because of the bad deeds he engaged in during his past life which impact him negatively now (bad karma)']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-bad-deeds-question" value="5"
                            v-model="surveyData['Sam is struggling at school because of the bad deeds he engaged in during his past life which impact him negatively now (bad karma)']" />
                    </td>
                </tr>
                <tr>
                    <td>5. Sam is struggling because his teachers do not give him enough academic support</td>
                    <td>
                        <input type="radio" name="sam-struggle-teachers-question" value="1"
                            v-model="surveyData['Sam is struggling because his teachers do not give him enough academic support']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-struggle-teachers-question" value="2"
                            v-model="surveyData['Sam is struggling because his teachers do not give him enough academic support']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-struggle-teachers-question" value="3"
                            v-model="surveyData['Sam is struggling because his teachers do not give him enough academic support']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-struggle-teachers-question" value="4"
                            v-model="surveyData['Sam is struggling because his teachers do not give him enough academic support']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-struggle-teachers-question" value="5"
                            v-model="surveyData['Sam is struggling because his teachers do not give him enough academic support']" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="radio" name="sam-no-academic-support-question" value="1"
                            v-model="surveyData['Sam is struggling because his parents do not give him enough academic support']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-no-academic-support-question" value="2"
                            v-model="surveyData['Sam is struggling because his parents do not give him enough academic support']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-no-academic-support-question" value="3"
                            v-model="surveyData['Sam is struggling because his parents do not give him enough academic support']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-no-academic-support-question" value="4"
                            v-model="surveyData['Sam is struggling because his parents do not give him enough academic support']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-no-academic-support-question" value="5"
                            v-model="surveyData['Sam is struggling because his parents do not give him enough academic support']" />
                    </td>
                </tr>
                <tr>
                    <td>
                        7. Sam is struggling because his teachers are unable to adapt their teaching style and methods to
                        meet the
                        different learning needs of their students
                    </td>
                    <td>
                        <input type="radio" name="sam-unable-to-adapt-question" value="1"
                            v-model="surveyData['Sam is struggling because his teachers are unable to adapt their teaching style and methods to meet the different learning needs of their students']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-unable-to-adapt-question" value="2"
                            v-model="surveyData['Sam is struggling because his teachers are unable to adapt their teaching style and methods to meet the different learning needs of their students']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-unable-to-adapt-question" value="3"
                            v-model="surveyData['Sam is struggling because his teachers are unable to adapt their teaching style and methods to meet the different learning needs of their students']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-unable-to-adapt-question" value="4"
                            v-model="surveyData['Sam is struggling because his teachers are unable to adapt their teaching style and methods to meet the different learning needs of their students']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-unable-to-adapt-question" value="5"
                            v-model="surveyData['Sam is struggling because his teachers are unable to adapt their teaching style and methods to meet the different learning needs of their students']" />
                    </td>
                </tr>
                <tr>
                    <td>8. All children are not made the same way in terms of their
                        mental abilities and capacity to learn; Sam is struggling because it is the Will of God</td>
                    <td>
                        <input type="radio" name="sam-will-of-god-question" value="1"
                    ...
                    <td>
                        <input type="radio" name="sam-will-of-god-question" value="2"
                            v-model="surveyData['All children are not made the same way in terms of their mental abilities and capacity to learn; Sam is struggling because it is the Will of God']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-will-of-god-question" value="3"
                            v-model="surveyData['All children are not made the same way in terms of their mental abilities and capacity to learn; Sam is struggling because it is the Will of God']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-will-of-god-question" value="4"
                            v-model="surveyData['All children are not made the same way in terms of their mental abilities and capacity to learn; Sam is struggling because it is the Will of God']" />
                    </td>
                    <td>
                        <input type="radio" name="sam-will-of-god-question" value="5"
                            v-model="surveyData['All children are not made the same way in terms of their mental abilities and capacity to learn; Sam is struggling because it is the Will of God']" />
                    </td>
                </tr>
            </table>
    ...
    <section class="flex items-center justify-center h-screen " v-show="currentStep === 4">
        <div class="result-box-questions ">
            ...
            <textarea
                v-model="surveyData['If Sam’s parents come to you as a friend to ask about what they should do to help their child with his academic work what would you advise them?']"
