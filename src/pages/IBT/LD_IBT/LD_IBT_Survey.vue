...
let surveyData = ref<SurveyData>({
  ...
  usrParticipatesInCanadianTraditions: "",
  usrEnjoysEngagingInSocialActivitiesWithCanadians: "",
  howComfortableUsrIsWhenWorkingWithCanadians: "",
  usrEnjoysCanadianEntertainment: "",
  usrsChildFindsReadingDifficult: false,
  usrsChildFindsMathematicsDifficult: false,
  usrsChildFindsWritingDifficult: false,
  usrIsInterestedInHavingCanadianFriends: "",
  otherAcademicActivitiesUsrsChildFindsDifficult: "",
  ...
  childStrugglesWithSchoolWork: "",
  extentChildStrugglesWithSchoolWork: "",
  ...
  childInCmmntReceivesSupportAtHome: false,
  childInCmmntReceivesSupportAtSchool: false,
