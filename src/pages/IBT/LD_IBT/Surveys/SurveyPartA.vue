  ...
  >
    ...
    >
      <span class="flex flex-wrap items-center gap-3">
        <label
          for="country"
          class="block mt-1 mb-0 font-medium bg-green-100 leading-7"
        ...
        <input
          ...
          v-model="surveyData.countryOfOrigin"
      ...
      <span class="flex flex-wrap items-center gap-3">
        <label for="province" class="mt-0 mb-0 bg-green-100"
      ...
      <span class="flex flex-wrap items-center gap-3 mt-5">
        <label for="spouse-1" class="mb-0 mt-0 bg-green-100"
      ...
      <span class="flex flex-wrap items-center gap-3 mt-5">
        <label for="parents" class="mb-0 mt-0 bg-green-100"
