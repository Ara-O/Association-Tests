  ...
  >
    ...
    >
      <span class="flex flex-wrap items-center gap-3">
        <label
          for="spouse-highest-education-level"
          class="font-medium mb-0 mt-0 bg-green-100"
          >8. What is your spouse's highest educational level</label
        >
        <select
          id="spouse-highest-education-level"
          v-model="props.surveyData.spouseHighestEduLvl"
      ...
      <input
        ...
        v-if="props.surveyData.spouseHighestEduLvl === 'Other (please specify)'"
        placeholder="Specify here"
        v-model="props.surveyData.spouseHighestEduLvlOther"
      />
      ...
      <span class="mt-5 flex flex-wrap items-center gap-3">
        ...
        <input
          ...
          v-model="props.surveyData.usrOccupInCanada"
      ...
      <div class="flex flex-wrap items-center gap-3 mt-5">
        ...
        <input
          ...
          placeholder="Enter Occupation"
          v-model="props.surveyData.usrOccupInFormerCountry"
        />
      </div>

      <span class="flex flex-wrap items-center gap-3 mt-5 mb-1.5">
        <label for="main-language" class="font-medium mt-0 mb-0 bg-green-100"
          >10. What is/are the main languages you use at home on a daily basis?
        </label>
        <input
          id="main-language"
          list="languages"
          class="rounded-md border border-gray-300 border-solid px-3 py-1 box-border w-48 text-[12.5px]"
          v-model="props.surveyData.mainLangUsedAtHome"
          required
        />
      ...
      <div>
        <label for="other-language-yes-no" class="font-medium mr-3 bg-green-100"
          >11. Do you use any other language/languages besides the home language
          indicated above?
        </label>
        <select
          v-model="props.surveyData.otherLangsUsedAtHomeYesOrNo"
          required
          class="w-48 ml-0"
        >
      ...
      <div>
        <label for="other-language" class="font-medium mr-3 bg-green-100"
        ...
        <input
          ...
          type="text"
          id="other-languages"
          :disabled="props.surveyData.otherLangsUsedAtHomeYesOrNo === 'No'"
          v-model="props.surveyData.otherLangsUsedAtHome"
          ...
          <table class="border-collapse text-center">
            ...
            <tr>
              ...
              <td>
                <input
                  type="radio"
                  name="writing-home-language"
                  value="Beginner"
                  v-model="props.surveyData.usrProficiencyInHomeLngWriting"
                  required
                />
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <input
                  type="radio"
                  name="speaking-home-language"
                  value="Beginner"
                  v-model="props.surveyData.usrProficiencyInHomeLngSpeaking"
                  required
                />
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <input
                  type="radio"
                  name="reading-home-language"
                  value="Beginner"
                  v-model="props.surveyData.usrProficiencyInHomeLngReading"
                  required
                />
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <input
                  ...
                  v-model="props.surveyData.usrProficiencyInEnglishWriting"
                  required
                />
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <input
                  ...
                  v-model="props.surveyData.usrProficiencyInEnglishSpeaking"
                  required
                />
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <input
                  ...
                  v-model="props.surveyData.usrProficiencyInEnglishReading"
                  required
                />
              </td>
              <td>
      ...
      <table class="border-collapse text-center">
        ...
        <tr>
          ...
          <td>
            <input
              v-model="props.surveyData.usrParticipatesInCanadianTraditions"
              type="radio"
              value="1"
              name="13a"
              id="rating_1"
        ...
        <tr>
          ...
          <td>
            <input
              v-model="
                props.surveyData
                  .usrEnjoysEngagingInSocialActivitiesWithCanadians
              "
              type="radio"
              value="1"
              name="13b"
        ...
        <tr>
          ...
          <td>
            <input
              v-model="
                props.surveyData.howComfortableUsrIsWhenWorkingWithCanadians
              "
              type="radio"
              value="1"
              name="13c"
        ...
        <tr>
          ...
          <td>
            <input
              v-model="props.surveyData.usrEnjoysCanadianEntertainment"
              type="radio"
              value="1"
              name="13d"
              id="13d_1"
        ...
        <tr>
          ...
          <td>
            <input
              v-model="props.surveyData.usrIsInterestedInHavingCanadianFriends"
              type="radio"
              value="1"
              name="13e"
              id="13e_1"
        ...
        <tr>
          ...
          <td>
            <input
              v-model="
                props.surveyData
                  .usrsChildPlaysWithChildrenFromDifferentCountries
              "
              type="radio"
              value="1"
              name="13f"
        ...
        <tr>
          ...
          <td>
            <input
              v-model="
                props.surveyData
                  .childsTeacherDiscussesCultureOfOriginRelatedHolidays
              "
              type="radio"
              value="1"
              name="13g"
      ...
      <span>
        ...
        <select
          v-model="props.surveyData.userIsAwareOfStrugglingChildInCmmnt"
          required
        >
          <option value="Yes">Yes</option>
          <option value="No">No</option>
        ...
        <table class="border-collapse text-center">
          ...
          <tr>
            <td>
              <input
                type="checkbox"
                v-model="props.surveyData.childInCmmntReceivesSupportAtHome"
              />
            </td>
            <td>
              <input
                type="checkbox"
                v-model="props.surveyData.childInCmmntReceivesSupportAtSchool"
              />
            </td>
            <td>
              <input
                type="checkbox"
                v-model="props.surveyData.childInCmmntReceivesSupportFromCmmnt"
              />
            </td>
          </tr>
        </table>
      ...
      <div class="my-3">
        ...
        <select
          class="w-48 my-5"
          v-model="props.surveyData.userIsAwareOfStrugglingChildInCntry"
          required
        >
          <option value="Yes">Yes</option>
          <option value="No">No</option>
            ...
            <tr>
              <td>
                <input
                  type="checkbox"
                  v-model="
                    props.surveyData.childInCountryReceivesSupportFromHome
                  "
                />
              </td>
              <td>
                <input
                  type="checkbox"
                  v-model="
                    props.surveyData.childInCountryReceivesSupportFromSchool
                  "
                />
              </td>
              <td>
                <input
                  type="checkbox"
                  v-model="
                    props.surveyData.childInCountryReceivesSupportFromCommunity
                  "
                />
              </td>
            </tr>
        ...
        <div class="mt-4 flex flex-wrap gap-x-5">
          ...
          <span class="inline-flex gap-2 flex-wrap">
            <input
              v-model="props.surveyData.childStrugglesWithSchoolWork"
              type="radio"
              class="my-auto"
              value="Yes"
              name="16a"
        ...
        <div class="mt-0 flex flex-wrap gap-x-5">
          ...
          <span class="inline-flex gap-2 flex-wrap">
            <input
              v-model="props.surveyData.extentChildStrugglesWithSchoolWork"
              type="radio"
              value="A litle"
              name="16b"
              class="my-auto"
        ...
        <div class="mt-0 flex flex-wrap gap-x-5">
          ...
          <span class="inline-flex gap-2 gap-y-4 flex-wrap">
            <input
              v-model="props.surveyData.usrsChildFindsReadingDifficult"
              type="checkbox"
              value="A litle"
              name="16c"
              class="my-auto"
            ...
            <input
              v-model="props.surveyData.usrsChildFindsWritingDifficult"
              type="checkbox"
              class="my-auto"
              name="16c"
              value="Moderately"
            ...
            <input
              v-model="props.surveyData.usrsChildFindsMathematicsDifficult"
              type="checkbox"
              class="my-auto"
              name="16c"
              value="A lot"
        ...
        <input
          ...
          v-model="
            props.surveyData.otherAcademicActivitiesUsrsChildFindsDifficult
          "
          placeholder="Other"
      ...
      <div class="mt-2 flex gap-8">
        <button
          class="gradient-btn gradient-green"
          type="button"
          @click="emits('go-back')"
        >
          Back
