      ...
      <div>
        <ul class="faces">
          ...
          <div class="choices">
            ...
            <h3 @click="validateChoice('John')" class="choice-name">John</h3>
            <h3 @click="validateChoice('Joe')" class="choice-name">Joe</h3>
            <h3 @click="validateChoice('Mark')" class="choice-name">Mark</h3>
            <h3 @click="validateChoice('James')" class="choice-name">James</h3>
          </div>
        </ul>
...
import * as handleIT from "../../../modules/handleITTrials_Name";
